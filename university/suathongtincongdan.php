...
$sql="Update citizen set FullName='$name',Birthday='$birthday',HomeAddress='$homeaddress',HomeTown='$hometown',
PlaceofBirth='$placeofbirth',Nation='$nation',Gender='$gender',Nationality='$nationality',Religion='$religion',Date='$date',IssuedBy='$issuedby',
Description='$description',StatusMarriage='$statusmarriage',Academiclevel='$academiclevel',Phone='$phone',CMND='$CMND',Email='$email',Status='$status'
where CitId='$iduser' ";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Sửa thông tin công dân</h4>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" class="form-material form-horizontal">
                                   ...
                                   <input type="submit" name="btn-update" value="Lưu">
