...
<body class="skin-blue fixed-layout">
  ...
  ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Danh sách công dân có tiền án tiền sự</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i><a href="them_cong_dan_tien_an_tien_su.php"> Thêm công dân</a></button>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
    ...
    <!-- Editable -->
    <script src="vuong/db.php"></script>
    <script type="text/javascript" src="vuong/jsgrid.js"></script>
    <script src="vuong/jsgrid-init.php"></script>
</body>
