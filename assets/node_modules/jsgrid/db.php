...
(function() {
    ...
    var db = {
        ...
        insertItem: function(insertingClient) {
            window.location.href="themcongdan.php";
        },

        updateItem: function(deletingClient) {
    ...
    db.clients = [
   		<?php while ($row=$query->fetch()): ?>
        {
        	...
        	ID:'<?php echo htmlspecialchars($row['CitId']) ?>',
            Name: "<?php echo htmlspecialchars($row['FullName']) ?>",
            Gender: <?php echo htmlspecialchars($row['Gender']) ?>,
            Birthday:"<?php echo $row['Birthday'] ?>",
            Address: "<?php echo htmlspecialchars($row['HomeAddress']) ?>",
            Religion: "<?php echo htmlspecialchars($row['Religion']) ?>",
            "Married": <?php echo htmlspecialchars($row['StatusMarriage']) ?>,
